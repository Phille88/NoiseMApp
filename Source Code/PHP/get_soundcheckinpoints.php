...
if (isset($_POST['userID']) && isset($_POST['latitude']) && isset($_POST['longitude']) && isset($_POST['dB']) && isset($_POST['accuracy']) && isset($_POST['quality']) && isset($_POST['placeName']) && isset($_POST['requestKey']) && $_POST["requestKey"] == REQUESTKEY) {
	...
	$points["amount"] = 2;
	$points["description"] = "You did a Sound Checkin at $placeName.";
	...
	//Sound Checkin points:
	$all_my_soundcheckins_result = mysql_query("SELECT scr.noiseRecordingID FROM soundcheckinrecordings scr WHERE scr.userID = $userID");
	if(mysql_num_rows($all_my_soundcheckins_result) == 499){
		$points["amount"] = 100;
		$points["description"] = "This is your 500th Sound Checkin!";
		array_push($response["points"], $points);
	...
	elseif(mysql_num_rows($all_my_soundcheckins_result) == 249){
		$points["amount"] = 100;
		$points["description"] = "This is your 250th Sound Checkin!";
		array_push($response["points"], $points);
	}
	elseif(mysql_num_rows($all_my_soundcheckins_result) == 99){
		$points["amount"] = 100;
		$points["description"] = "This is your 100th Sound Checkin!";
		array_push($response["points"], $points);
	...
	elseif(mysql_num_rows($all_my_soundcheckins_result) == 49){
		$points["amount"] = 75;
		$points["description"] = "This is your 50th Sound Checkin!";
		array_push($response["points"], $points);
	...
	elseif(mysql_num_rows($all_my_soundcheckins_result) == 19){
		$points["amount"] = 50;
		$points["description"] = "This is your 20th Sound Checkin!";
		array_push($response["points"], $points);
	}
	elseif(mysql_num_rows($all_my_soundcheckins_result) == 9){
		$points["amount"] = 20;
		$points["description"] = "This is your 10th Sound Checkin!";
		array_push($response["points"], $points);
	}
	elseif(mysql_num_rows($all_my_soundcheckins_result) == 4){
		$points["amount"] = 10;
		$points["description"] = "This is your 5th Sound Checkin!";
		array_push($response["points"], $points);
	}
	elseif(mysql_num_rows($all_my_soundcheckins_result) == 0){
		$points["amount"] = 25;
		$points["description"] = "This is your first Sound Checkin!";
		array_push($response["points"], $points);
		
		$badge["badgeID"] = 3001;
		$badge["amount"] = 50;
		$badge["description"] = "You earned a first Sound Checkin badge!";
		array_push($response["badges"], $badge);
	}
	...
	$points_result = mysql_query("INSERT INTO totalpoints (userID, totalPoints) VALUES ($userID, $totalPoints) ON DUPLICATE KEY UPDATE totalPoints = totalPoints + $totalPoints");
